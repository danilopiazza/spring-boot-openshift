package io.github.danilopiazza.spring.boot.openshift.web.controller;
...
import io.github.danilopiazza.spring.boot.openshift.repository.FruitRepository;
...
public class FruitController {
    ...
    private void verifyFruitExists(Integer id) {
        if (!this.repository.existsById(id)) {
            throw new NoSuchElementException(String.format("Fruit with id=%d was not found", id));
        }
    }
    ...
    private void verifyCorrectPayload(Fruit fruit) {
        ...
        if (!Objects.isNull(fruit.getId())) {
            throw new IllegalArgumentException("Id field must be generated");
        }
    }
}
